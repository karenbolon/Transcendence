...
ALTER TABLE "player-progression" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
DROP TABLE "player-progression" CASCADE;--> statement-breakpoint
ALTER TABLE "achievement_definitions" ALTER COLUMN "category" SET DEFAULT 'origins';--> statement-breakpoint
ALTER TABLE "achievement_definitions" ADD COLUMN "icon" varchar(10) DEFAULT '🏆' NOT NULL;--> statement-breakpoint
