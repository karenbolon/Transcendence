...
<script lang="ts">
	...
	let { gameMode, winScore, speedPreset, player2Name, isLoggedIn = false, onGameModeChange, onWinScoreChange, onSpeedChange, onPlayer2NameChange }: Props = $props();
...
<div class="settings-panel">
	...
	<!-- Settings below only apply to local/computer — online uses FindMatch -->
	{#if gameMode !== 'online'}
