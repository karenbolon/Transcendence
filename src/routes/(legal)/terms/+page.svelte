<div class="min-h-screen bg-pong-darker text-gray-100">
	<div class="max-w-3xl mx-auto px-4 py-10">
		...
		<p class="text-gray-200 leading-relaxed">
			Welcome to ft_transcendence (“the Service”), a web-based multiplayer
			application developed as part of the 42 curriculum. By accessing or
			using the Service, you agree to be bound by these Terms of Service
			(“Terms”). If you do not agree with these Terms, you must not use
			the Service.
		</p>
		...
		<p class="text-gray-200 leading-relaxed">
			The Service is provided for educational and demonstration purposes
			only and is an online platform that allows users to:
		</p>
		<ul class="list-disc pl-6 mt-2 space-y-1 text-gray-200">
			...
			<li>
				Participate in real-time features such as matches, tournaments,
				or chat
			</li>
		</ul>
		<div class="my-8 h-px bg-white/5"></div>
		...
		<p class="text-gray-200 leading-relaxed">You must:</p>
		<ul class="list-disc pl-6 mt-2 space-y-1 text-gray-200">
		...
		<p class="text-gray-200 leading-relaxed">You agree not to:</p>
		<ul class="list-disc pl-6 mt-2 space-y-1 text-gray-200">
		...
		<p class="text-gray-200 leading-relaxed mt-4">
			As this is an educational project, features may change, reset, or be
			removed at any time.
		</p>
		<div class="my-8 h-px bg-white/5"></div>
		...
		<p class="text-gray-200 leading-relaxed mt-4">
			User-generated content remains the property of the user who created
			it.
		</p>
		<div class="my-8 h-px bg-white/5"></div>
		...
		<ul class="list-disc pl-6 mt-2 space-y-1 text-gray-200">
			<li>
				We are not liable of data loss, service interruptions, or
				gameplay issues
			</li>
		...
		<p class="text-gray-200 leading-relaxed">
			...
			including applicable GDPR provisions, without regard to
